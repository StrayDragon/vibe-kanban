...
- [ ] 3.1 Tailwind major spike: attempt upgrade in isolation, document required config changes and UI drift risk, and decide go/no-go based on e2e + manual smoke.
