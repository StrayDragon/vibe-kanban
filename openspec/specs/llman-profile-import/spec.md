# Capability: LLMAN Profile Import

## Purpose
Enable importing llman-managed Claude Code env groups into selectable agent profile variants without manual env duplication.
