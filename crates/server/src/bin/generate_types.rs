...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::task_groups::RunNextMilestoneStepStatus::decl(),
        server::routes::task_groups::RunNextMilestoneStepResponse::decl(),
        db::models::task_group::TaskGroupGraph::decl(),
